...
App.layout = {
    main: {
        main: 'web/modules/app/views/layout.html',
        left: 'web/modules/app/views/leftmenu.html'
    }
};

App.views = {
    home: 'web/modules/app/views/home.html',
    error404: 'web/modules/app/views/404.html',
    error500: 'web/modules/app/views/500.html'
};
